    ...
    <div className="pt-32 pb-24 px-6 min-h-screen">
      <div className="max-w-4xl mx-auto prose dark:prose-invert">
        ...
        <section className="mb-12">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            BunkCalc is a personal attendance management tool designed for university students. The App allows tracking daily class attendance with 1-tap quick actions, calculating semester-forward bunk budgets, securing the app with Biometric Fingerprint / Face ID and PIN authentication, managing 10 modular settings sub-pages, displaying lab sessions as 2-hour timetable blocks, managing cancelled class pool adjustments, and receiving local notifications. The App operates entirely offline with local-only data storage. No account creation, credentials, or internet connection is required for core functionality.
          </p>
        </section>
